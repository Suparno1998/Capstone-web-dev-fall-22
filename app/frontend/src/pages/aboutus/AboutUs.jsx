  ...
  return (
    <div>
     ...
     <section id="about">
          ...
          <div class="col-md-4">
            <div class="about-col">
              <h2 class="title"><a href="#">Our Mission</a></h2>
               <p>We simplify the meal planning process. Our tools equip households to eat better food, eat together, save money at the grocery store, and have a less stressful cooking experience.</p>
        ...
        <p>Our delicious meal plans are designed by registered dietitians and food experts to help you lose weight, eat more fiber, go vegan and more.
        </p>
        <div class="d-flex justify-content-center">
        <a href="#" class="btn-sm-default-web">Read more</a>
        </div>
